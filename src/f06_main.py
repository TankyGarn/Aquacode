...
lakslus_Aldalen_2022 = lakslus_Aldalen[lakslus_Aldalen["location_time_year"] == 2022][
    ["location_time_week", "lice_female_mature", "lice_movables", "temperature"]
]
f3 = plt.figure()
plt.plot(
    lakslus_Aldalen_2022["location_time_week"],
    lakslus_Aldalen_2022["lice_female_mature"],
)
...
lakslus_Nautvik_2022 = lakslus_Nautvik[lakslus_Nautvik["location_time_year"] == 2022][
    ["location_time_week", "lice_female_mature", "lice_movables", "temperature"]
]
f4 = plt.figure()
plt.plot(
    lakslus_Nautvik_2022["location_time_week"],
    lakslus_Nautvik_2022["lice_female_mature"],
)
plt.xlabel("Weeks in 2022")
plt.ylabel("Adult female lice number")
...
salmon_licence = pd.read_csv(
    "/Users/taohongliao/Desktop/TEP4221/project/data/interim/salmon_licence.csv"
)

# test are there
lakslus_region_mean["Lokalitetsnummer"].isin(salmon_licence["LOK_NR"]).value_counts()

lakslus_region_mean_new = lakslus_region_mean.merge(
    salmon_licence, how="inner", left_on="Lokalitetsnummer", right_on="LOK_NR"
)  # Combine the data of salmon_licence and lakslus_region_mean by the same location number


#%%
lakslus_region_mean_new.to_csv(
    "/Users/taohongliao/Desktop/TEP4221/project/data/interim/lakslus_region_mean_new.csv"
)
...
lakslus_geopd = gpd.GeoDataFrame(
    lakslus_region_mean,
    geometry=gpd.points_from_xy(lakslus_region_mean.Lon, lakslus_region_mean.Lat),
)
